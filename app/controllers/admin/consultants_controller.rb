class Admin::ConsultantsController < ApplicationController
  ...
  def index
    @consultants = Admin::Consultant.all
  end
  ...
  # GET /consultants/new
  def new
    @consultant = Admin::Consultant.new
  ...
  def create
    @consultant = Admin::Consultant.new(consultant_params)
  ...
  private
    ...
    def set_consultant
      @consultant = Admin::Consultant.find(params[:id])
    end
